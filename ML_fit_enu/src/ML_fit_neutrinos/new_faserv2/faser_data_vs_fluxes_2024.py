...
neutrino_pdfs_mu_dpm_El = np.loadtxt(
    "/Users/jukkajohn/Masterscriptie/faser_nufluxes_ml/ML_fit_enu/src/ML_fit_neutrinos/run_3_gens/fit_dpmjet/El_fit/mu_pdf.txt",
    delimiter=",",
)
neutrino_pdfs_mub_dpm_El = np.loadtxt(
    "/Users/jukkajohn/Masterscriptie/faser_nufluxes_ml/ML_fit_enu/src/ML_fit_neutrinos/run_3_gens/fit_dpmjet/El_fit/mub_pdf.txt",
    delimiter=",",
)
...
def plot(
    ...
    faser_pdf_mu_dpm, x_faser = read_pdf(pdf, x_vals, 14)
    faser_pdf_mub_dpm, x_faser = read_pdf(pdf, x_vals, -14)
    faser_pdf_mu_dpm = faser_pdf_mu_dpm * x_vals * 1.16186e-09
    faser_pdf_mub_dpm = faser_pdf_mub_dpm * x_vals * 1.16186e-09

    pdf = "FASER_2412.03186_SIBYLL+SIBYLL_7TeV"
    faser_pdf_mu_syb, x_faser = read_pdf(pdf, x_vals, 14)
    faser_pdf_mub_syb, x_faser = read_pdf(pdf, x_vals, -14)
    faser_pdf_mu_syb = faser_pdf_mu_syb * x_vals * 1.16186e-09
    faser_pdf_mub_syb = faser_pdf_mub_syb * x_vals * 1.16186e-09

    pdf = "FASER_2412.03186_EPOS+POWHEG_7TeV"
    faser_pdf_mu_epos, x_faser = read_pdf(pdf, x_vals, 14)
    faser_pdf_mub_epos, x_faser = read_pdf(pdf, x_vals, -14)
    faser_pdf_mu_epos = faser_pdf_mu_epos * x_vals * 1.16186e-09
    faser_pdf_mub_epos = faser_pdf_mub_epos * x_vals * 1.16186e-09

    pdf = "FASER_2412.03186_QGSJET+POWHEG_7TeV"
    faser_pdf_mu_qgs, x_faser = read_pdf(pdf, x_vals, 14)
    faser_pdf_mub_qgs, x_faser = read_pdf(pdf, x_vals, -14)
    faser_pdf_mu_qgs = faser_pdf_mu_qgs * x_vals * 1.16186e-09
    faser_pdf_mub_qgs = faser_pdf_mub_qgs * x_vals * 1.16186e-09
    ...
    ratio_center = faser_pdf_mu_dpm / mean_mu_faser
    axrL.plot(x_vals, ratio_center, linestyle="-", color="red")

    ratio_center = faser_pdf_mu_epos / mean_mu_faser
    axrL.plot(x_vals, ratio_center, linestyle="-", color="green")

    ratio_center = faser_pdf_mu_qgs / mean_mu_faser
    axrL.plot(x_vals, ratio_center, linestyle="-", color="pink")

    ratio_center = faser_pdf_mu_syb / mean_mu_faser
    ...
    ratio_center = faser_pdf_mub_dpm / mean_mub_faser
    axrM.plot(x_vals, ratio_center, linestyle="-", color="red")

    ratio_center = faser_pdf_mub_epos / mean_mub_faser
    axrM.plot(x_vals, ratio_center, linestyle="-", color="green")

    ratio_center = faser_pdf_mub_qgs / mean_mub_faser
    axrM.plot(x_vals, ratio_center, linestyle="-", color="pink")

    ratio_center = faser_pdf_mub_syb / mean_mub_faser
    axrM.plot(x_vals, ratio_center, linestyle="-", color="black")
