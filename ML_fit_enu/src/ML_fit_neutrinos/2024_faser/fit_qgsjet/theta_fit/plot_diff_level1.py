rom matplotlib.legend_handler import HandlerTuple
...
def plot(
    ...
    # )
    axR.set_title(
        r"$\mathcal{L}_{\mathrm{pp}} = 65.6 \mathrm{fb}^{-1} \ \theta \ QGSJET$",
        loc="right",
    )
    axR.set_title(r"$\mathrm{FASER \ 2024}, \ \mathrm{Level\ 1}$", loc="left")
