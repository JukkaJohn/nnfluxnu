...
<<<<<<< HEAD
    faser_pdf_mu = faser_pdf_mu * x_vals * 1.16186e-09 * 20
    faser_pdf_mub = faser_pdf_mub * x_vals * 1.16186e-09*20
=======
    faser_pdf_mu = faser_pdf_mu * x_vals  * 20
    faser_pdf_mub = faser_pdf_mub * x_vals *20
>>>>>>> bf5bffb69ec4a318117f0a4aa6bdaab926d87e87
    ...
    # if preproc == 1:
    title_str = r"$\mathrm{QGSJET}+\mathrm{POWHEG}$"
    # if preproc == 2:
    ...
    plt.savefig("fit_QGSJET_theta.pdf")
    plt.show()
