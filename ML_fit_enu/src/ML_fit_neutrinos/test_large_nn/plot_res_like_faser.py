...
def plot(
    ...
    fig = plt.figure(figsize=(4, 3), dpi=300)  # 2 rows, 3 columns
    gs = gridspec.GridSpec(
        1,
        1,
    )
    gs.update(left=0.17, right=0.97, top=0.92, hspace=0.18, wspace=0.20)
    ...
    # plt.show()
    plt.savefig("fit_faser_plot_faser_nn_no_wd.pdf")
