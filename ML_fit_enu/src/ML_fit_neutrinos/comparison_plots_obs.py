    ...
    for generator in generators:
        for geometry in geometries:
            neutrino_pdfs_mu_dpm_Eh = np.loadtxt(
                f"{geometry}/fit_{generator}/Eh_fit/mu_pdf.txt", delimiter=","
            )
            ...
            neutrino_pdfs_mu_dpm_El = np.loadtxt(
                f"{geometry}/fit_{generator}/El_fit/mu_pdf.txt", delimiter=","
            )
            ...
            neutrino_pdfs_mu_dpm_Enu = np.loadtxt(
                f"{geometry}/fit_{generator}/Enu_fit/mu_pdf.txt", delimiter=","
            )
            ...
            neutrino_pdfs_mu_dpm_theta = np.loadtxt(
                f"{geometry}/fit_{generator}/theta_fit/mu_pdf.txt", delimiter=","
            )
            ...
            fig = plt.figure(figsize=(12.8, 9.0), dpi=300)  # 2 rows, 3 columns
            ...
            if generator == "epos" and geometry == "2024_faser":
            ...
            if generator == "qgsjet" and geometry == "2024_faser":
            ...
            if generator == "sibyll" and geometry == "2024_faser":
            ...
            plt.savefig(f"{geometry}_{generator}_compare_obs.pdf")
            plt.show()
