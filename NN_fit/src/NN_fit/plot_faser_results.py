...
def plot(
    ...
    fig = plt.figure(figsize=(10.2, 4.4), dpi=300)  # 2 rows, 3 columns
    gs = gridspec.GridSpec(2, 3, height_ratios=[3, 1])
    gs.update(left=0.08, right=0.97, top=0.92, hspace=0.28, wspace=0.30)
    ...
    # axR.set_title(r"$\mathrm{FASER} \ arXiv \ 2412:03186}$", loc="left")
    title_str = r"$\mathrm{FASER} \ \mathrm{arXiv} \ 2412:03186, \ \mathcal{L}_{\mathrm{pp}} = 65.6 \mathrm{fb}^{-1}$"
    ...
    plt.savefig(f"{dir_plot}/fit_faser_plot_faser.pdf")
    plt.show()
