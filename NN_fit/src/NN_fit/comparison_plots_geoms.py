    ...
    for obs in observables:
        for gen in gens:
            ...
            neutrino_pdfs_mu_run3 = np.loadtxt(
                f"run_3_gens/fit_{gen}/{obs}_fit/mu_pdf.txt", delimiter=","
            )
            neutrino_pdfs_mub_run3 = np.loadtxt(
                f"run_3_gens/fit_{gen}/{obs}_fit/mub_pdf.txt", delimiter=","
            )

            neutrino_pdfs_mu_2024faser = np.loadtxt(
                f"2024_faser/fit_{gen}/{obs}_fit/mu_pdf.txt", delimiter=","
            )
            neutrino_pdfs_mub_2024faser = np.loadtxt(
                f"2024_faser/fit_{gen}/{obs}_fit/mub_pdf.txt", delimiter=","
            )

            neutrino_pdfs_mu_faserv2 = np.loadtxt(
                f"faserv2/fit_{gen}/{obs}_fit/mu_pdf.txt", delimiter=","
            )
            neutrino_pdfs_mub_faserv2 = np.loadtxt(
                f"faserv2/fit_{gen}/{obs}_fit/mub_pdf.txt", delimiter=","
            )

            neutrino_pdfs_mu_high_lumi = np.loadtxt(
                f"high_lumi_faserv/fit_{gen}/{obs}_fit/mu_pdf.txt", delimiter=","
            )
            neutrino_pdfs_mub_high_lumi = np.loadtxt(
                f"high_lumi_faserv/fit_{gen}/{obs}_fit/mub_pdf.txt", delimiter=","
            )
            ...
            faser_pdf_mu_run3, x_faser = read_pdf(pdf_run3, x_vals, 14)
            faser_pdf_mub_run3, x_faser = read_pdf(pdf_run3, x_vals, -14)
            ...
            faser_pdf_mu_2024faser, x_faser = read_pdf(pdf_2024faser, x_vals, 14)
            faser_pdf_mub_2024faser, x_faser = read_pdf(pdf_2024faser, x_vals, -14)
            ...
            faser_pdf_mu_faserv2, x_faser = read_pdf(pdf_faserv2, x_vals, 14)
            faser_pdf_mub_faserv2, x_faser = read_pdf(pdf_faserv2, x_vals, -14)
            ...
            faser_pdf_mu_high_lumi, x_faser = read_pdf(pdf_high_lumi, x_vals, 14)
            faser_pdf_mub_high_lumi, x_faser = read_pdf(pdf_high_lumi, x_vals, -14)
            ...
            gs.update(
                left=0.09, right=0.97, top=0.92, bottom=0.08, hspace=0.15, wspace=0.15
            )
            ...
            plt.savefig(f"{gen}_{obs}_compare_geoms.pdf")
            # plt.show()
