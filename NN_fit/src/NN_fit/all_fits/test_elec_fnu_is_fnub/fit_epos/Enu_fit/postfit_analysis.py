...
from data_epos import data_needed_for_fit
from control_file_epos import (
    hyperparams,
)
from postfit_measures import Measures
from postfit_criteria import Postfit
from plot_epos import plot

# Get number of reps from make runscripts
filename_postfit = "fit_report_epos_Enu.txt"
(
    preproc,
    lr,
    fit_level,
...
filename_binsize = "../../../FKtables/data/binning/FK_Enu_binsize.dat"


filename_data_mu = (
    "../../../FKtables/data/data/data_Enu_FASERv_Run3_EPOS+POWHEG_7TeV_numu_W.dat"
)
filename_data_mub = (
    "../../../FKtables/data/data/data_Enu_FASERv_Run3_EPOS+POWHEG_7TeV_nubmu_W.dat"
)
filename_uncert_mu = "../../../FKtables/data/uncertainties/uncertainties_Enu_FASERv_Run3_EPOS+POWHEG_7TeV_numu_W.dat"
filename_uncert_mub = "../../../FKtables/data/uncertainties/uncertainties_Enu_FASERv_Run3_EPOS+POWHEG_7TeV_nubmu_W.dat"
