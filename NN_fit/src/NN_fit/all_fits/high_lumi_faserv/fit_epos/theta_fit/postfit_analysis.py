...
filename_postfit = "fit_report_epos_theta.txt"
(
    preproc,
    lr,
    fit_level,
...
filename_binsize = "../../../FKtables/data/binning/FK_theta_binsize.dat"


filename_data_mu = (
    "../../../FKtables/data/data/data_theta_FASERv_Run3_EPOS+POWHEG_7TeV_numu_W.dat"
)
filename_data_mub = (
    "../../../FKtables/data/data/data_theta_FASERv_Run3_EPOS+POWHEG_7TeV_nubmu_W.dat"
)
filename_uncert_mu = "../../../FKtables/data/uncertainties/uncertainties_theta_FASERv_Run3_EPOS+POWHEG_7TeV_numu_W.dat"
filename_uncert_mub = "../../../FKtables/data/uncertainties/uncertainties_theta_FASERv_Run3_EPOS+POWHEG_7TeV_nubmu_W.dat"
filename_fk_mub_n = "../../../FKtables/data/fastkernel/FK_theta_final_nubmu_n.dat"
filename_fk_mub_p = "../../../FKtables/data/fastkernel/FK_theta_final_nubmu_p.dat"
filename_fk_mu_n = "../../../FKtables/data/fastkernel/FK_theta_final_numu_n.dat"
filename_fk_mu_p = "../../../FKtables/data/fastkernel/FK_theta_final_numu_p.dat"
filename_binsize = "../../../FKtables/data/binning/FK_theta_binsize.dat"
(
    data,
    sig_sys,
