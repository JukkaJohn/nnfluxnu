...
# import torch
#
# Clear the file contents at the start of the job
...
for i in range(10):
    ...
    print(f"Iteration {i}: chi_square_for_postfit = {chi_square_for_postfit}")
    print(f"Shape: {chi_square_for_postfit.shape}")
